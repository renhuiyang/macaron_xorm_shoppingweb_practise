...
func sign_struct(param interface{}) string {
	...
	//追加密钥
	sign += c.Config.Alipay.Key //AlipayKey
...
func buildRequest_WEBBank(o Order, defaultBank string) (string, string) {
	...
	param.NotifyUrl = c.Config.Alipay.NotifyUrl //WebNotifyUrl
	param.OutTradeNo = o.Uuid
	param.Partner = c.Config.Alipay.Partner //AlipayPartner
	param.PaymentType = 1
	param.ReturnUrl = c.Config.Alipay.ReturnUrl //WebReturnUrl
	param.SellerEmail = c.Config.Alipay.Email   //WebSellerEmail
...
func buildRequest_WAP(o Order) (string, string) {
	...
	param.PaymentType = 1
	param.ReturnUrl = c.Config.Alipay.ReturnUrl //WebReturnUrl
	param.SellerId = c.Config.Alipay.Partner    //WebSellerId
